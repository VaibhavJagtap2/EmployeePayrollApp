...
const createInnerHtml = () => {
  ...
  for (var empPayrollData of empPayrollList) {
    innerHTML1 = innerHTML1 +
      ...
      "<td>" +
      `<button onclick=remove('${empPayrollData._id}')><img id='1' alt='delete' src='C:/Users/Admin/EmpPayRollApp/assets/icons/delete-black-18dp.svg'></button>` +
      `<button onclick=update('${empPayrollData._id}')><img id='1' alt='edit' src='C:/Users/Admin/EmpPayRollApp/assets/icons/create-black-18dp.svg'></button>` + 
      "</td>" +
      "</tr>"
  };
